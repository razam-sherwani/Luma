...
def create_summary_table(accounts):
    ...
    if len(accounts) > 10:
        print(f"... and {len(accounts) - 10} more (see hcp_credentials.txt for complete list)")
    
    print("-" * 80)
    print(f"Total HCP accounts created: {len(accounts)}")
    print("Complete credentials saved to: hcp_credentials.txt")
...
def main():
    ...
    print("📋 Check 'hcp_credentials.txt' for complete login information")
